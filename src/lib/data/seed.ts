 ...
 *
 * Preview media is real: each item has a poster still and a looping video
 * recording of its demo UI (generated by scripts/record-previews.mjs into
 * public/previews), plus a live interactive demo at public/demos/<slug>.html
 * used for the detail-page iframe. Replace these with your own via /admin.
 *
...
// Placeholder tint per item — the card's fallback if a poster ever 404s.
...
const media = (slug: string) => ({
  previewImageUrl: `/previews/${slug}.jpg`,
  previewVideoUrl: `/previews/${slug}.webm`,
  liveDemoUrl: `/demos/${slug}.html`,
});
